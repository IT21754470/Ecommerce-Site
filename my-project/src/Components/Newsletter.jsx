  ...
  return (
    ...
    <div className='max-w-[1240px] mx-auto grid lg:grid-cols'>
        <div>
            ...
            <h1>Sign up to our newletter and stay up to date</h1>
        ...
        <div className='my-4'>
            ...
            <p> We care about the production of your data .Read our {''}<span className='text-[#00df9a]'>Privacy Policy</span></p>
